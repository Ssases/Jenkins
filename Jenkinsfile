pipeline {
    ...
    stages {
        ...
        stage('setgitcreds') {
             git credentialsId: 'PAT_TOKEN', https://ssases:$PAT_TOKEN@github.com/Ssases/upload.git: 'upload'
             git credentialsId: 'PAT_TOKEN', https://ssases:$PAT_TOKEN@github.com/Ssases/upload-copy.git: 'upload-copy'
            }
